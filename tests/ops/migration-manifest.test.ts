...
describe('forward-only migration manifest gate', () => {
  it('pins the merged goals schema release as 48 immutable migrations', () => {
    ...
    expect(migrationRows).toHaveLength(48);
    ...
    expect(migrationRows.at(-1)).toMatch(
      /^20260914180000\|20260914180000_available_cash_projection\.sql\|[a-f0-9]{64}$/,
    );
