...
const liveReleaseHead = 'e1d250468d7bd213ecbf561b25a3a814b0f7cd25';
...
describe('forward-only migration manifest gate', () => {
  it('pins the merged goals schema release as 44 immutable migrations', () => {
    ...
    expect(migrationRows).toHaveLength(44);
    ...
    expect(migrationRows.at(-1)).toMatch(
      /^20260914140000\|20260914140000_goals_schema\.sql\|[a-f0-9]{64}$/,
    );
