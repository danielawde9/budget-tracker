...
export function LoansPage({ gateway }: { gateway: LoansGateway }) {
  ...
  return <main className="app-shell">
    ...
    {selectedLoan && subdialog === 'target' ? <TargetDialog loan={selectedLoan} month={state.month} onClose={() => setSubdialog(null)} onSave={state.setMonthlyTarget} /> : null}
    {selectedLoan && correctionEventId ? <CorrectionDialog loan={selectedLoan} eventId={correctionEventId} onClose={() => setCorrectionEventId(null)} onSave={state.reverseEvent} /> : null}
  </main>;
}
