/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8b1bd6cb360f50f23b4e76d78499156e)
// Runtime types generated with workerd@1.20260908.1 2026-09-10 
interface __BaseEnv_Env {
	HOUSEHOLD_INVITATION_IP_LIMITER: RateLimit;
	HOUSEHOLD_INVITATION_ACTOR_LIMITER: RateLimit;
	ASSETS: Fetcher;
	APP_ORIGIN: string;
	SUPABASE_URL: string;
	SUPABASE_ANON_KEY: string;
	RESEND_API_KEY: string;
	HOUSEHOLD_INVITATION_FROM: string;
	HOUSEHOLD_INVITATION_REPLY_TO: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "RESEND_API_KEY" | "HOUSEHOLD_INVITATION_FROM" | "HOUSEHOLD_INVITATION_REPLY_TO">> {}
}
